...
namespace Sussex.Lhcra.Roci.Viewer.UI.Controllers
{
    ...
    {
        private readonly ILogger<PlexusController> _logger;
        ...
        public PlexusController(
            ILogger<PlexusController> logger,
            ...
            string patientGender, string patientPracticeOdsCode, string patientAddress)
        {
            ...
            patientGender, patientPracticeOdsCode, patientAddress);
